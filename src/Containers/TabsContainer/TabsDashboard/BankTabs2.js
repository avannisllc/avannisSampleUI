...
class BankTabs extends React.Component {
  ...
  render() {
    return (
      ...
      <Card>
        <CardHeader tag="h6" style={{borderBottom: 0}}>
      
          <Nav tabs fill>
            <NavItem style={{marginBottom: "-9px"}}>
              <NavLink 
                // style={{borderBottom: 0}}
                active={this.state.activeTab==='interviews'} 
                onClick={() => this.setActiveTab('interviews')}
              >
                Interview Data
              </NavLink>
            </NavItem>
            <NavItem>
              <NavLink 
                ...
                active={this.state.activeTab==='sample'} 
                onClick={() => this.setActiveTab('sample')}
              >
                Sample Data
              </NavLink>
            </NavItem>
            <NavItem>
              <NavLink 
                style={{marginBottom: "-9px"}}
                active={this.state.activeTab==='quotas'} 
                onClick={() => this.setActiveTab('quotas')}
              >
                Quotas
              </NavLink>
            </NavItem>
